...
window.KCMPS_STORE_DATA = {
  ...
  leaves: {
    ...
    "dtf":   { customLabel: "Custom DTF design request", customBlurb: "Have your own artwork? Upload it at checkout. We'll review, quote, and only bill you after you approve.", image: "assets/leaves/dtf.jpg" },
    "subli": { customLabel: "Custom sublimation design request", customBlurb: "Full-color sublimation on light/poly fabrics. Send your design — approved and billed before we print.", image: "assets/leaves/subli.jpg" },
    "hotmelt": { comingSoon: true, customLabel: "Custom hotmelt design request", customBlurb: "Durable heat-applied vinyl lettering and designs. Tell us what you need and we'll quote it.", image: "assets/leaves/hotmelt.jpg" },
